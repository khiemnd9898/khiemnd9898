...
const PhotoViewModal = memo(({isVisible, onCloseRequest, images, initialIndex, ...props}: Props) => {
    useEffect(() => {
        let stack = isVisible ? StatusBar.pushStackEntry({
            translucent: false,
    ...
    return <SModal
        ...
        {...props}
    >
        <PhotoViewContent images={images} initialIndex={initialIndex} onCloseRequest={onCloseRequest}/>
    </SModal>
});
